...
const SearchDestination = () => {
  return (
    <div className="px-[200px] flex gap-x-4 mb-5">
      <div className="w-[126px] h-[48px] bg-[#7126B5] rounded-xl flex items-center justify-center">
        <a
          href="#"
      ...
      <div className="w-[126px] h-[48px] bg-[#E2D4F0] rounded-xl flex items-center justify-center">
